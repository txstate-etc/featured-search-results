...
<ul>
  ...
  <li><code><span class='synOp'>[</span><i>optional</i><span class='synOp'>]</span></code> <i><span class='terminator'>- syntax components displayed in square brackets are <u>optional</u>.</span></i></li>
...
<ul>
  <li><code><span class='descriptor'>&lt;compound search&gt;</span> = <span class='synOp'>[&lcub;</span><span class='descriptor'>&lt;search phrase&gt;</span><span class='synOp'>&lcub;</span><span class='terminator'>,</span><span class='synOp'>|</span><span class='terminator'>;</span><span class='synOp'>|</span><span class='descriptor'><span class='terminator'>&lt;spaces&gt;</span></span><span class='synOp'>&rcub;&rcub;</span><span class='terminator'>...</span><span class='synOp'>]</span></code></li>
  <li>
...
<pre class="js"><code><span class='keyword'>'title'</span>, <span class='keyword'>'tags'</span>, <span class='keyword'>'url'</span>, <span class='keyword'>'entries.keywords'</span></code></pre>
