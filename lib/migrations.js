...
async function cloneSearchIdTableData () {
  ...
  const peopleTableDDL = `
    CREATE TABLE people (
      ...
      pronouns   varchar(128)          DEFAULT NULL COMMENT 'The third person personal pronoun antecedant-agreement mappings found in Banner or SAP.',
      private    tinyint(1)   NOT NULL DEFAULT '1'  COMMENT 'Whether this person has requested to be kept private from public dissemination.',
      PRIMARY KEY (userid),
