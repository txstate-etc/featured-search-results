...
class Helpers {
  ...
  static getPeopleDef () {
    ...
    const peopleDef = { hash: {}, defaults: [], fields: '' } // type tableDef -- I need to figure out how to create tableDef type that enforces creating these.
    peopleDef.hash = {
      'lastname':  'lastname',
      'last name': 'lastname',
      'last':      'lastname',
  ...
  static getSortClause (tableDef, sortOption) {
    ...
    return ' order by ' + (tableDef.fields.has(sortOption) ? sortOption : sortDefault)
  }
